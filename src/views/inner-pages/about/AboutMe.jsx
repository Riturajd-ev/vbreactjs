                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-xl-5">
                    ...
                    >
                      ...
                      VB Easy is a certified, award-winning software development company that predominantly  focuses on client requirements and endeavour to deliver <br/>result oriented solutions.<br/> We create every project with great diligence and offer the optimum solution and ROI to boost business growth.
                      </p>
                      <p className="fz-30 has-black-color has-secondary-font">
                      We are experts in Web Technologies, Mobile Technologies, and Digital Marketing and provide cutting edge solutions so that you do not have to hire multiple companies to get your project done.<br/> We have separate departments for Web Development, App Development, Digital Marketing, and On-Demand Hiring.All these departments work together to turn your project into a success story.
                      </p>
                    </div>
                    {/* <!--Spacer--> */}
                    <div
                    ...
                    >
                      ...
                      ></div>
                      <p className="fz-30 has-black-color has-secondary-font">
                      IND: New Delhi, 110094 <br />
                        <a href="mailto:support@vbeasy.com">
                        support@vbeasy.com
                        </a>
                        <br />
                        <a href="tel:+6835688986">+91 9718352518</a>
                      </p>
                      {/* <!--Spacer--> */}
                      <div
                        className="ptf-spacer"
