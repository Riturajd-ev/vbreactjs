...
const ServiceDetails = () => {
  return (
    <div>
      <Helmet>
        <title>VBEASY - Service Details</title>
      </Helmet>
              ...
              <div className="row">
                <div className="col-xl-9">
                  ...
                  <div
                    ...
                    data-aos-delay="0"
                  >
                    <h1 className="large-heading">Web App Development</h1>
                    {/* <!--Spacer--> */}
                    <div
                      className="ptf-spacer"
